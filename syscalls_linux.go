...
var syzkallSupport = map[string]func(*prog.Syscall, *prog.Target, string) (bool, string){
	...
	"syz_hugetlb":                 alwaysSupported,
	"syz_mount_huge":              alwaysSupported,
	"syz_hugetlb_surplus":         alwaysSupported,
	"syz_disable_hugepages":       alwaysSupported,
	"syz_disable_transparent":     alwaysSupported,
	"syz_enable_transparent":      alwaysSupported,
	"syz_create_hugepage_fd":      alwaysSupported,
	"syz_write_to_hugepage":       alwaysSupported,
	"syz_delete_hugepage":         alwaysSupported,
	"syz_read_from_page":          alwaysSupported,
}
